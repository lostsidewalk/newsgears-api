...
public class FeedFetchResponse {
    ...
    Map<String, List<QueryDefinition>> queryDefinitions;
    ...
    private FeedFetchResponse(List<FeedDefinition> feedDefinitions, Map<String, List<QueryDefinition>> queryDefinitions, Map<NewsApiSources,
            Map<String, String>> allNewsApiV2Sources, List<NewsApiCountries> allNewsApiV2Countries, List<NewsApiCategories> allNewsApiV2Categories,
            List<NewsApiLanguages> allNewsApiV2Languages)
    {
    ...
    public static FeedFetchResponse from(List<FeedDefinition> feedDefinitions, Map<String, List<QueryDefinition>> queryDefinitions,
